...
class tx_rx_simulation(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/mehdi/LoRa_Fl_Compression.proj/hardwaretest03/lora/tx_payload.txt', False, 0, 0)
